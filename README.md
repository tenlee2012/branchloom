...
- 从家谱树、人物列表和时间线浏览家庭资料。
- Android 和窄屏界面通过左侧滑出菜单切换页面：点击顶部菜单按钮或从左边缘右滑打开，点击遮罩、左滑或返回关闭；底部不再显示导航标签栏。
- 家谱树与人物档案搜索默认优先展示姓名完全匹配的人物，其次为姓名开头、姓名包含匹配，最后为生平、备注等其他资料匹配；同等匹配下主姓名优先于别名。排序在分页前完成，人物档案仍可手动按最近更新或出生时间排序。
- 桌面家谱树支持部分姓名、字号搜索，高亮匹配人物并点击定位；选中人物后，在家谱卡片上查看其对其他人物的日常称呼，如爸爸、妈妈、爷爷、奶奶、太奶奶。长幼不明时保留“兄弟”“姐妹”等合称；上四代及更远的直系祖辈显示“老祖宗”及代数。称呼仅根据已载入资料的最短关系路径计算，收养、继亲、监护、已结束的伴侣关系及信息不足的情况保留关系说明，不写入家谱资料。
